...
use App\Http\Controllers\UserListes;
...
// check via provider AuthServiceProvider
...
Route::middleware(['auth','acc_type'])->group(function () {
    ...
    Route::get("/utilisateur", [UserListes::class,'getUserList'])->name("utilisateur");
    
    Route::post('/reset-password/{id}', [UserListes::class, 'resetPassword']);
    Route::delete('/delete-user/{id}', [UserListes::class, 'DeleteUser'])->name('delete.user');
