...
<aside class="main-sidebar sidebar-primary elevation-1">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="/profile" class="d-block" style="text-transform:uppercase;">{{ Auth::user()->name }}</a>
            </div>
        </div>
        ...
        @elseif(Auth::check() && Auth::user()->acc_type == 1)
            <!-- Sidebar Menu -->
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    data-accordion="false">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview" style="display: none;">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('exportmedidata') }}"
                                    class="{{ request()->is('exportmedidata') ? 'nav-link active' : 'nav-link' }}">
        ...
        @elseif(Auth::check() && Auth::user()->acc_type == 2)
            <!-- Sidebar Menu -->
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('register') }}"
                            class="{{ request()->is('register') ? 'nav-link active' : 'nav-link' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('utilisateur') }}"
                            class="{{ request()->is('utilisateur') ? 'nav-link active' : 'nav-link' }}">
