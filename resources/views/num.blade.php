        ...
        <div class="row">
          <div class="col nopadding">
            <nav class="nav text-bg-success">
              ...
              <a class="nav-link active text-white position-absolute top-0 end-0" aria-current="page" href="{{in_array(auth()->user()->mle, ['84644','84372']) ? route('dashboard') : '#'}}">{{in_array(auth()->user()->mle, ['84644','84372']) ? 'Table de board' : auth()->user()->mle}}</a>
