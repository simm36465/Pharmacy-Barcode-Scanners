                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="progress-group">
                                Pourcentage médicaments Remboursables
                            ...
                            <div class="progress-group">
                                Pourcentage médicaments Non Remboursables
                            ...
                            <div class="progress-group">
                                Pourcentage médicaments Hors ANAM
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table m-0" id="table1">
                            ...
                            <tbody>
                                @foreach ($ordonanceCounts as $item)
                                    <tr>
                                        <td>{{ $item->num_eng }}</td>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-center">
                        <strong>Statistiques des utilisateurs jusq'au : @php echo Date("m-d-Y") @endphp</strong>

                    </p>

                    <table class="table m-2" id="table1">
                        <thead>
                            <tr>
    ...
    @section('dash_script')
        <script>
            ...
            @foreach ($totalsByMonthYear as $data)
                ...
                var formattedDate = dateObject.toLocaleString('fr-FR', { month: 'short', year: 'numeric' });
