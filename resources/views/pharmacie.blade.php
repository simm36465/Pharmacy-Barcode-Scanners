...
<div class="container-fluid text-center">
    ...
    <div class="row align-items-end">
      ...
      <div class="col-2 bg-warning text-white p-0">
        <button class="nextbtn" onclick="newOrdannance()" id="newOrdonnance">Nouvelle ordonnance</button>
      </div>
    </div>
  </div>
      ...
      success: function(response) {
       ...
       // console.log(data.remb ,data.is_anam);
        ...
        if (data.remb === 1) {
          ...
          MR += parseFloat(data.PPV.toFixed(2));
          console.log(parseFloat(data.PPV));  
        ...
        //console.log("MR = " + MR +"\n"+ "MNR = " + MNR);
        console.log(typeof data.is_anam);
        if (data.is_anam === 1) {
